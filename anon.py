...
async def send_rich_message(chat_id, markdown_text: str, reply_markup=None):
...
async def edit_rich_message(chat_id, message_id, markdown_text: str, reply_markup=None) -> bool:
...
async def show_screen(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str,
    ...
    if query:
        if use_rich and await edit_rich_message(chat_id, query.message.message_id, text, reply_markup):
    ...
    if msg_id:
        if use_rich and await edit_rich_message(chat_id, msg_id, text, reply_markup):
    ...
    if use_rich:
        rich_msg_id = await send_rich_message(chat_id, text, reply_markup)
