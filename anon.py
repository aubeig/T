    ...
    try:
        ...
        if context.user_data.get('replying_to'):
            ...
            if message_info:
                ...
                try:
                    await context.bot.send_message(
                        to_user, notification, parse_mode='HTML',
...
REPORT_STYLE = '''
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background:
                radial-gradient(circle at 15% 0%, rgba(112,0,255,0.16) 0%, transparent 45%),
                radial-gradient(circle at 85% 20%, rgba(0,240,255,0.10) 0%, transparent 40%),
                var(--bg);
            color: var(--text);
            min-height: 100vh;
            padding: 48px 20px;
